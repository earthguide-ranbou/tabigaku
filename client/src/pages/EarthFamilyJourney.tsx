...
<p style={{textAlign: "center", lineHeight: 2, marginTop: 24, fontSize: "clamp(14px,3.2vw,16px)"}}>
          ...
          <p style={{textAlign: "center", lineHeight: 2, marginTop: 16, fontSize: "clamp(14px,3.2vw,16px)"}}>
            増やしたいのは、地球をひとつの大きな家のように感じ、人生を思いっきり楽しみながら、地球の未来のために動く「Earth Family」。
          </p>
          <p style={{textAlign: "center", lineHeight: 2, marginTop: 16, fontSize: "clamp(14px,3.2vw,16px)"}}>
      ...
      <section className="efjw-sec"><div className="wrap">
        ...
        <details style={{marginTop: 20, maxWidth: 560, margin: "20px auto 0"}}>
          <summary style={{fontSize: "clamp(13px,3.1vw,15px)", fontWeight: 800, color: "#d65a3a", cursor: "pointer", listStyle: "none", textAlign: "center", padding: "12px 24px", border: "2px solid #d65a3a", borderRadius: 999, display: "block"}}>実績を見る ▼</summary>
      ...
      <section className="efjw-sec"><div className="wrap">
        ...
        <div className="efjw-flow">
          ...
          <div className="step"><b>🌐 DAO</b>DAOという新時代のコミュニティ。</div>
        </div>
          ...
          <div style={{ display: "grid", gap: 20, marginTop: 32 }}>
            ...
            <a href="https://earthguide.tabigaku.party/" target="_blank" rel="noopener noreferrer" className="group" style={{ display: "block", background: "#fff", borderRadius: 20, padding: "24px 20px", textDecoration: "none", color: "inherit", boxShadow: "0 4px 20px rgba(0,0,0,.08)" }}>
              ...
              <p style={{ fontSize: "clamp(13px,3.1vw,15px)", lineHeight: 1.8, color: "#555", margin: 0 }}>
                家族も、友人も、ひとりでも。
                <br />お年寄りも、若者も、小さな子どもたちも。
                <br /><br />みんなが一緒に、海や山、島や里山を巡る旅へ。
                <br />現地で生きる人たちと向き合い、自然の中で体を動かし、対話を重ねる。
                <br /><br />おじいちゃんおばあちゃんが、小さな子どもたちの前で自然といい大人ぶりをする。
                <br />子どもたちは、誰かを支える優しさを、自然と持っている。
                <br /><br />血のつながりじゃなくても、そんなふうに寄り添える関係。
                <br />年齢も、国籍も、境遇も超えて、ごちゃまぜのメンバーで国内外を旅する。
                <br /><br />旅の途中で、きっと「帰ってきたい」と思える場所が見つかるはず。
