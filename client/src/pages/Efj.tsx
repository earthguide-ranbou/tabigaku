    ...
    <div className="efj">
      ...
      <section className="efj-sec">
        <Reveal>
          ...
          <p className="efj-lead">道中の案内とコーディネートへのお気持ちだけをお預かりする、仲間の旅への同行というかたち。基本は移動や食事、宿泊などが実費になります。行き先は時にインスピレーションでみんなで決めたり、フレキシブルに行きます。</p>
          <div className="efj-plans">
            <div className="efj-plan best">
              ...
              <p className="jitsu">同行のお気持ち（案内・コーディネート）＋実費（宿泊・食事・移動など）</p>
              <ul>
            ...
            <div className="efj-plan">
              ...
              <p className="jitsu">同行のお気持ち＋実費（宿泊・食事・移動など）</p>
              <ul>
          ...
          <div className="efj-note">
            <b>🌱 この旅のかたち</b><br />
            これは、らんぼうが大好きな人と場所を訪ねてまわる夏の旅。そこに、ご家族や仲間が「一緒に行きたい！」と同行してくれるかたちです。現地で落ち合って、同じ時間を過ごして、またそれぞれの暮らしへ帰っていく。おすすめの宿や便は、いくらでも相談に乗ります。お預かりするのは、道中の案内とコーディネートへのお気持ちだけ。行き先は、時にはインスピレーションでみんなで決めたり、フレキシブルに。その柔らかさも、この旅ならではのおもしろさとして一緒に楽しんでください。<br /><br />
            <b>🎫 うれしい割引</b><br />
            ・らんぼう塾割引｜10,000円割引（お一人様＆一家族全体で）<br />
            ・家族割引｜ご家族でご参加の場合、小学生以上の2人目以降のお子さまやご家族分のお気持ちは、そのスタイルの半額以上のドネーション制。「この旅の価値に期待してこれだけ応援したい！」そんな感覚に合わせて金額をお選びください。<br />
        ...
        <Reveal>
          ...
          <div className="efj-know">
            ...
            <div className="efj-knowbox">
              ...
              ※お申し込み後、案内のお気持ちをお振込みください。お振込みの確認をもってご参加確定となります。
            </div>
            <div className="efj-knowbox">
              <b>📮 お問い合わせ</b>
