...
export default function EarthFamily() {
  useEffect(() => {
    ...
    const DESC = "世界中に「おかえり」と言い合えるつながりを増やす。旅、教育、家族、地域をつなぐ活動。移住のキッカケ100人以上、子どもたちと歩いた距離500km以上。あなたはどんな形で未来へ参加しますか？";
    ...
    setMeta("property", "og:image", "https://tabigaku.party/efj/efj-hero.png");
  ...
  return (
    <div style={{ background: "#f7f3ea", color: "#2b2b2b", ...maru }}>
      ...
      <header className="relative">
        <img
          src={IMG + "efj-hero.png"}
          alt="Earth Family Journey"
      ...
      <section className="max-w-2xl mx-auto px-5 py-20 md:py-28">
        ...
        <div className="space-y-6 text-[15px] md:text-base leading-[2.2]">
          <p>
            子どもたちと遊ばせに行っていた川が、ある日、枯れてしまった。海に行っても、かつてのように魚が跳ねる姿は少なくなっていた。生き物が減り、人と人が分断されていく。SNSでは誰かを責めることばかりが増えて、本当の「対話」が少なくなっている。
          </p>
          <p>
            そんな世界を、未来の子どもたちに手渡していいのだろうか。でも僕は思う。インプットだけの世界じゃなく、アウトプットもある。行ったりきたりすることで、何かが生まれる可能性がある。旅から学び、学びを旅に還元する。そうした循環の中で、人と人が「おかえり」と言い合える場所を、一つずつ増やしていく。
          </p>
          <p>
            だから僕は動き出した。旅をして、学校をつくって、未来の子どもたちに手渡したい地球を、ともにつくっていく。
          </p>
        </div>
        <div className="mt-12 text-center">
          <img
            src={IMG + "dried-river.jpg"}
            alt="かつて子どもたちが遊んでいた川。今は水が枯れ、石だけが残っている。"
            className="w-full rounded-2xl shadow-lg object-cover"
            style={{ height: "clamp(200px, 40vw, 360px)" }}
          />
          <p className="text-xs text-neutral-500 mt-3">
            かつては水が流れ、魚が泳いでいた。今は石だけが残っている。
          </p>
        </div>
      </section>
      ...
      <section className="max-w-3xl mx-auto px-5 py-20 md:py-28">
        ...
        <div className="mt-12 bg-white rounded-2xl p-6 md:p-8 shadow-md">
          <h3 style={serif} className="font-bold text-lg text-center mb-6">
            具体的な数字で見る活動の軌跡
          </h3>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 text-center">
            <div>
              <p className="text-3xl md:text-4xl font-black" style={{ color: "#d65a3a" }}>100<span className="text-lg">人+</span></p>
              <p className="text-sm mt-2 text-neutral-600">移住のキッカケ</p>
            </div>
            <div>
              <p className="text-3xl md:text-4xl font-black" style={{ color: "#d65a3a" }}>100<span className="text-lg">人+</span></p>
              <p className="text-sm mt-2 text-neutral-600">子どもたちと歩いた</p>
            </div>
            <div>
              <p className="text-3xl md:text-4xl font-black" style={{ color: "#d65a3a" }}>500<span className="text-lg">km+</span></p>
              <p className="text-sm mt-2 text-neutral-600">子どもたちと歩いた距離</p>
            </div>
            <div>
              <p className="text-3xl md:text-4xl font-black" style={{ color: "#d65a3a" }}>500<span className="text-lg">回+</span></p>
              <p className="text-sm mt-2 text-neutral-600">講演・上映・対話</p>
            </div>
            <div>
              <p className="text-3xl md:text-4xl font-black" style={{ color: "#d65a3a" }}>1<span className="text-lg">周</span></p>
              <p className="text-sm mt-2 text-neutral-600">地球を旅した</p>
            </div>
            <div>
              <p className="text-3xl md:text-4xl font-black" style={{ color: "#d65a3a" }}>60<span className="text-lg">人+</span></p>
              <p className="text-sm mt-2 text-neutral-600">神山への移住者</p>
            </div>
          </div>
        </div>
      </section>
