  ...
  return (
    <div className="henro-page">
      ...
      <div style={{textAlign: "center", padding: "48px 16px"}}>
        <p style={{color: "#5a4a3a", fontSize: "clamp(0.8rem, 2.5vw, 1rem)", letterSpacing: "0.2em", marginBottom: "1.5rem"}}>＼ お遍路ジャーニーをシェア ／</p>
        <div style={{display: "flex", justifyContent: "center", gap: "12px", flexWrap: "wrap"}}>
          <a href="https://twitter.com/intent/tweet?url=https://www.tabigaku.party/henro&text=小3〜中3が四国最南端・足摺岬から歩く6日間の巡礼「歩きお遍路ジャーニー vol.5 高知編」。歩いた距離だけ強くなれる。10/10出発・定員10名。" target="_blank" rel="noopener noreferrer" style={{display: "inline-flex", alignItems: "center", justifyContent: "center", width: 44, height: 44, borderRadius: "50%", background: "#000", color: "#fff", textDecoration: "none", boxShadow: "0 4px 14px rgba(0,0,0,0.18)"}}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
          </a>
          <a href="https://www.facebook.com/sharer/sharer.php?u=https://www.tabigaku.party/henro" target="_blank" rel="noopener noreferrer" style={{display: "inline-flex", alignItems: "center", justifyContent: "center", width: 44, height: 44, borderRadius: "50%", background: "#1877F2", color: "#fff", textDecoration: "none", boxShadow: "0 4px 14px rgba(0,0,0,0.18)"}}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
          </a>
          <a href="https://social-plugins.line.me/lineit/share?url=https://www.tabigaku.party/henro" target="_blank" rel="noopener noreferrer" style={{display: "inline-flex", alignItems: "center", justifyContent: "center", width: 44, height: 44, borderRadius: "50%", background: "#06C755", color: "#fff", textDecoration: "none", boxShadow: "0 4px 14px rgba(0,0,0,0.18)"}}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 5.9 2 10.7c0 2.8 1.5 5.3 3.8 6.9.2.1.3.3.2.5l-.7 2.4c-.1.3.2.5.5.4l2.9-1.7c.2-.1.4-.2.7-.1.8.2 1.6.3 2.5.3 5.52 0 10-3.9 10-8.7S17.52 2 12 2zm-2.8 8.5c0 .3-.2.5-.5.5h-3c-.3 0-.5-.2-.5-.5v-3c0-.3.2-.5.5-.5h3c.3 0 .5.2.5.5v3zm6 0c0 .3-.2.5-.5.5h-3c-.3 0-.5-.2-.5-.5v-3c0-.3.2-.5.5-.5h3c.3 0 .5.2.5.5v3zm6 0c0 .3-.2.5-.5.5h-3c-.3 0-.5-.2-.5-.5v-3c0-.3.2-.5.5-.5h3c.3 0 .5.2.5.5v3z"/></svg>
          </a>
          <a href="https://www.threads.com/intent/post?url=https://www.tabigaku.party/henro" target="_blank" rel="noopener noreferrer" style={{display: "inline-flex", alignItems: "center", justifyContent: "center", width: 44, height: 44, borderRadius: "50%", background: "#333", color: "#fff", textDecoration: "none", boxShadow: "0 4px 14px rgba(0,0,0,0.18)"}}>
          ...
          <a href="https://www.instagram.com/earthguide.ranbow?igsh=MWc2aWR3MnByY2ZrZg==" target="_blank" rel="noopener noreferrer" style={{display: "inline-flex", alignItems: "center", justifyContent: "center", width: 44, height: 44, borderRadius: "50%", background: "#E4405F", color: "#fff", textDecoration: "none", boxShadow: "0 4px 14px rgba(0,0,0,0.18)"}}>
          ...
          <a href="https://www.facebook.com/share/1cCefwXVat/" target="_blank" rel="noopener noreferrer" style={{display: "inline-flex", alignItems: "center", justifyContent: "center", width: 44, height: 44, borderRadius: "50%", background: "#1877F2", color: "#fff", textDecoration: "none", boxShadow: "0 4px 14px rgba(0,0,0,0.18)"}}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
          </a>
          <a href="https://www.threads.com/@earthguide.ranbow" target="_blank" rel="noopener noreferrer" style={{display: "inline-flex", alignItems: "center", justifyContent: "center", width: 44, height: 44, borderRadius: "50%", background: "#333", color: "#fff", textDecoration: "none", boxShadow: "0 4px 14px rgba(0,0,0,0.18)"}}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M12.186 24h-.007c-3.581-.024-6.334-1.205-8.184-3.509C2.35 18.44 1.5 15.586 1.472 12.01v-.017c.03-3.579.879-6.43 2.525-8.482C5.845 1.205 8.6.024 12.18 0h.014c2.746.02 5.043.725 6.826 2.096 1.677 1.29 2.858 3.13 3.509 5.467l-2.04.569c-1.104-3.96-3.898-5.984-8.304-6.015-2.91.022-5.11.936-6.54 2.717C4.307 6.504 3.616 8.914 3.59 12c.025 3.086.718 5.496 2.152 7.164 1.432 1.781 3.632 2.695 6.542 2.717 2.073.015 3.816-.528 5.186-1.614 1.33-1.055 2.102-2.557 2.295-4.467l2.04.569c-.266 2.57-1.324 4.567-3.146 5.953-2.17 1.658-4.9 2.478-8.073 2.478z"/></svg>
          </a>
          <a href="https://substack.com/@ranbou?utm_source=share&utm_medium=android&r=33vqvi" target="_blank" rel="noopener noreferrer" style={{display: "inline-flex", alignItems: "center", justifyContent: "center", width: 44, height: 44, borderRadius: "50%", background: "#FF6719", color: "#fff", textDecoration: "none", boxShadow: "0 4px 14px rgba(0,0,0,0.18)"}}>
