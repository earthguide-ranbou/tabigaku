      ...
      <section className="juku-sec">
        <Reveal>
          ...
          <div className="juku-quote">
            ...
            地球のあちこちで、らんぼうが巡り会ってきた「本物」たちが塾にやってきます。海を渡る伝統航海術師、島で暮らしを自給する実践者、土地に根ざして新しい仕事を生み出す人、地域を動かす変わり者——。教科書には載っていない生き方、活動のはじめ方、好きを仕事に変える仕事づくりを、本人の言葉で直接聞ける特別授業です。「こんな生き方があったのか」。その出逢いが、あなたの人生の選択肢を増やします。
          </div>
          <div className="juku-quote">
